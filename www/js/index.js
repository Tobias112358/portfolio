...
import { initGranular, playGranularSynth, stopGranularSynth } from './granular.js';
...
async function run() {
    ...
    const stopGranularSynth = document.getElementById('stop-granular-synth-button');
    ...
    if (stopGranularSynth){
        stopGranularSynth.addEventListener('click', async () => {
            stopGranularSynth
        })
    }
